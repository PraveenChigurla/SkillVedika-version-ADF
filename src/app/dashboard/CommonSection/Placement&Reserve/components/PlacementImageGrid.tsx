...
const resolveImageUrl = (imgUrl: string): string => {
  if (!imgUrl) return "/default-uploads/Skill-vedika-Logo.jpg";
  ...
  // Invalid backend paths that should be filtered out
  if (
    imgUrl.startsWith("/mnt/") || 
    imgUrl.startsWith("/contact-us/") || 
    (imgUrl.startsWith("/storage/") && !imgUrl.includes("http"))
  ) {
    return "/default-uploads/Skill-vedika-Logo.jpg";
  }
  
  // Valid if it starts with / (frontend path)
...
const SortableItem = memo(function SortableItem({
  ...
  const handleImageError = useCallback((e: React.SyntheticEvent<HTMLImageElement>) => {
    ...
    (e.target as HTMLImageElement).src = "/default-uploads/Skill-vedika-Logo.jpg";
  }, []);
